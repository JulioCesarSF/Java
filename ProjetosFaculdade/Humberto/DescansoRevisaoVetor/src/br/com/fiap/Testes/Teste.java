	...
	public static void main(String[] args) throws Excecao {
		...
		try {
			...
			while (Helper.q("Cadastrar novo veículo?", "Cadastro de Veículo") != 1 && maxV <= 4) {
				...
				Veiculo o = new Veiculo(Helper.aS("Ano do veículo?"), Helper.a("Modelo do veículo?"),
						Helper.a("Montadora do veículo?"), Helper.aD("Valor do veículo?"));
