...
public class Exerc07 {
	...
	public static void main(String[] args) {
		...
		try (Scanner t = new Scanner(System.in)) {
			...
			int maiorQtd = 0;
			for (int i = 0; i < preco.length; i++) {
				System.out.println("Qtde:" + qtd[i] + "\tPreÃ§o: R$" + preco[i] + "\tTotal: R$" + (qtd[i] * preco[i]));
			...
			System.out.println("ComissÃ£o: R$" + (totalGeral * 0.05));
			System.out.println("Preço da maior quantidade R$" + preco[maiorQtd]);
